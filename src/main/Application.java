...
public class Application {
	...
	public static void main(String[] args) {
		...
		String[][] user = { { "order_billing_name", "Vincent Mark" }, { "order_email", "vincem4rk@gmail.com" },
				{ "order_tel", "3025843046" }, { "bo", "123 Happy Drive" }, { "order_billing_zip", "19711" },
	    ...
	    JLabel author = new JLabel("by: Vincent Mark & Kyle Kruskamp");
